...
#include <libusb-cpp/transferdefs.hpp>
...
//		void Start(std::shared_ptr<std::atomic_flag> );
	...
	public:
        ...
        virtual void SetupPacket(std::uint8_t Request, std::uint16_t wValue, std::uint16_t wIndex, DataTransferDirection_t transferDirection /* = HOST_TO_DEVICE */, RequestType_t requestType /*= REQ_VENDOR*/, RequestRecipient_t recipient /*= REC_ENDPOINT*/ );
